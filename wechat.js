$(function(){
	...
	$(".input li").on("click",function(){
		$(".input li").eq($(this).index()).find("span").addClass("mess").parent().siblings().find("span").removeClass("mess");
		$(".content section").eq($(this).index()).addClass("block").siblings().removeClass("block");
	})

	$(".mess_tab li").on("mouseover",function(){
		$(".mess_tab li").eq($(this).index()).addClass("active").siblings().removeClass("active");
	}).on("mouseout",function(){
		$(this).removeClass("active");
	})

	$(".mess_tab li").on("click",function(){
		$(".mess_tab li").eq($(this).index()).addClass("on").siblings().removeClass("on");
		$(".mess_div div").eq($(this).index()).addClass("show").siblings().removeClass("show");
	})
